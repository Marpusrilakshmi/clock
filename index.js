...
function gather(){
    ...
    var z=document.getElementById("dinner").value;
        ...
        if(hours==x)
        {
    a.src="wakeup_image.svg"
    document.getElementById("para").innerHTML="LET'S HAVE SOME BREAKFAST";
    document.getElementById("gud").innerHTML="GOOD MORNING"
        }
        else if(hours==y)
        {
    a.src="lunch_image.svg";
    document.getElementById("para").innerHTML="LET'S HAVE SOME LUNCH";
    document.getElementById("gud").innerHTML="GOOD AFTERNOON"
    
        }
        else if(hours==z)
        {
    a.src="goodnight_image.svg";
    document.getElementById("para").innerHTML="LET'S HAVE SOME DINNER";
    document.getElementById("gud").innerHTML="GOOD NIGHT";
